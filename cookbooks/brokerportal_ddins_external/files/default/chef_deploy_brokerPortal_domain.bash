...
./deploy.bash $adminServer $adminPort brokerPortal_cluster $deployerUser $deployerPassword BrokerApp $deployHomeDir/Applications/BrokerPortal-5.0.0.ear 2>&1 | tee -a $LOG_FILE 2>&1
